...
namespace NUITizenGallery
{
    ...
    internal class ButtonPage8 : ContentPage
    {
        ...
        internal ButtonPage8(Window window)
        {
            ...
            textButton.BackgroundImage = CommonResource.GetResourcePath() + "component/c_buttonbasic/c_basic_button_white_bg_normal_9patch.png";
            ...
            iconButton.BackgroundImage = CommonResource.GetResourcePath() + "component/c_buttonbasic/c_basic_button_white_bg_normal_9patch.png";
            ...
            iconTextButton.BackgroundImage = CommonResource.GetResourcePath() + "component/c_buttonbasic/c_basic_button_white_bg_normal_9patch.png";
            ...
            var utilityServiceButtonStyle = new ButtonStyle()
            {
                ...
                BackgroundImage = CommonResource.GetResourcePath() + "3. Button/rectangle_point_btn_normal.png",
                BackgroundImageBorder = new Rectangle(5, 5, 5, 5)
            };
            utilityServiceButton = new Button();
            utilityServiceButton.ApplyStyle(utilityServiceButtonStyle);
            utilityServiceButton.ImageShadow = new ImageShadow(CommonResource.GetResourcePath() + "3. Button/rectangle_btn_shadow.png", new Rectangle(5, 5, 5, 5));
            ...
            var utilityToggleButtonStyle = new ButtonStyle()
            {
                ...
                {
                    Normal = CommonResource.GetResourcePath() + "3. Button/rectangle_toggle_btn_normal.png",
                    Selected = CommonResource.GetResourcePath() + "3. Button/rectangle_point_btn_normal.png",
                },
                Overlay = new ImageViewStyle()
                {
                    ResourceUrl = new Selector<string>
            ...
            utilityToggleButton.ImageShadow = new ImageShadow(CommonResource.GetResourcePath() + "3. Button/rectangle_btn_shadow.png", new Rectangle(5, 5, 5, 5));
            ...
            var utilityOvalButtonStyle = new ButtonStyle()
            {
                BackgroundImage = new Selector<string>
                {
                    Normal = CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_normal.png",
                    Selected = CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_select.png",
                },
                Overlay = new ImageViewStyle()
                {
                    ResourceUrl = new Selector<string>
                    {
                        Pressed = CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_press_overlay.png",
                        Other = ""
                    }
                },
                Text = new TextLabelStyle()
            ...
            utilityOvalButton.ImageShadow = new ImageShadow(CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_shadow.png", new Rectangle(5, 5, 5, 5));
            ...
            {
                IsSelectable = true,
                BackgroundImage = new Selector<string> { All = CommonResource.GetResourcePath() + "3. Button/rectangle_btn_normal.png" },
                BackgroundImageBorder = new Selector<Rectangle> { All = new Rectangle(5, 5, 5, 5) },
                ImageShadow = new ImageShadow(CommonResource.GetResourcePath() + "3. Button/rectangle_btn_shadow.png", new Rectangle(5, 5, 5, 5)),

                Overlay = new ImageViewStyle
                {
                    ResourceUrl = new Selector<string> { Pressed = CommonResource.GetResourcePath() + "3. Button/rectangle_btn_press_overlay.png", Other = "" },
            ...
            {
                IsSelectable = false,
                BackgroundImage = new Selector<string> { All = CommonResource.GetResourcePath() + "3. Button/[Button] App Primary Color/rectangle_point_btn_normal_24c447.png" },
                BackgroundImageBorder = new Selector<Rectangle> { All = new Rectangle(5, 5, 5, 5) },
            ...
            ButtonStyle familyToggleButtonStyle = new ButtonStyle
            {
                ...
                BackgroundImage = new Selector<string>
                {
                    Normal = CommonResource.GetResourcePath() + "3. Button/[Button] App Primary Color/rectangle_toggle_btn_normal_24c447.png",
                    Selected = CommonResource.GetResourcePath() + "3. Button/[Button] App Primary Color/rectangle_point_btn_normal_24c447.png",
                },
                BackgroundImageBorder = new Selector<Rectangle> { All = new Rectangle(5, 5, 5, 5) },
            ...
            ButtonStyle familyOvalButtonStyle = new ButtonStyle
            {
                ...
                {
                    Normal = CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_normal.png",
                    Selected = CommonResource.GetResourcePath() + "3. Button/[Button] App Primary Color/oval_toggle_btn_select_24c447.png",
                },
                BackgroundImageBorder = new Selector<Rectangle> { All = new Rectangle(5, 5, 5, 5) },

                ImageShadow = new ImageShadow(CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_shadow.png", new Rectangle(5, 5, 5, 5)),

                Overlay = new ImageViewStyle
                {
                    ResourceUrl = new Selector<string> { Pressed = CommonResource.GetResourcePath() + "3. Button/oval_toggle_btn_press_overlay.png", Other = "" },
                    Border = new Selector<Rectangle> { All = new Rectangle(5, 5, 5, 5) },
                },
            };
